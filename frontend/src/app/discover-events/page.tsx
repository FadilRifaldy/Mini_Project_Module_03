...
import { getNewsHeadline } from "@/lib/backend"; // ganti fungsi ini sesuai data event-mu

export default async function DiscoverEvents() {
  const events = await getNewsHeadline(); // Ambil data event dari backend
              ...
              <article className="flex flex-col h-full">
                ...
                <div className="px-5 pt-4 space-y-3 flex-1">
                  ...
                  <div className="pt-3 pb-3 flex flex-col text-xs text-gray-500 space-y-1 border-t border-gray-300">
                    ...
                    <span>
                      🎟️ Available: {event.availableTickets} /{" "}
                      {event.totalTickets}
                    </span>
                  </div>
                </div>
